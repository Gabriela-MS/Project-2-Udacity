...
""" Attention from line 107 -  Use of 'f-strings': check https://www.geeksforgeeks.org/formatted-string-literals-f-strings-python/ """
    ...
    def play_game(self):
        ...
        while True:
            ...
            if repeat == 'y' or repeat == 'Y':
                ...
                print("Sad to see you leave. Bye bye")
                break
